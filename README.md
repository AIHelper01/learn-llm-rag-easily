...
1. **大模型简介**，什么是大模型、大模型特点是什么、LangChain 是什么，如何开发一个 LLM 应用；
...
5. [系统评估与优化](./notebook/C5%20系统评估与优化/) 
   1. [如何评估 LLM 应用](./notebook/C5%20系统评估与优化/7.1%20如何评估%20LLM%20应用.ipynb)
   2. [评估并优化生成部分](./notebook/C5%20系统评估与优化/7.2%20评估并优化生成部分.ipynb)
   3. [评估并优化检索部分](./notebook/C5%20系统评估与优化/7.3%20评估并优化检索部分.md)
