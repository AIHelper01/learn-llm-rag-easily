...
| rerank    |           | # rerank_client = OllamaLLM(base_url='http://localhost:11434', model='linux6200/bge-reranker-v2-m3:latest') |                                                              |                                                              |
|           |           |                                                              |                                                              |                                                              |
...
|           | 本地部署                                                     | 调API |
| --------- | ------------------------------------------------------------ | ----- |
| LLM       | 非推理模型： Qwen/Qwen2.5-14B-Instruct<br />推理模型：deepseek-ai/DeepSeek-R1-Distill-Qwen-14B |       |
| Embedding | BAAI/bge-m3                                                  |       |
| Reranker  | BAAI/bge-reranker-v2-m3                                      |       |

https://bge-model.com/index.html
